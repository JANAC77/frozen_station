...
const CephalopodsPage = () => {
  const specificProducts = [
    {
      id: 'whole-squid',
      name: 'Whole Squid',
      image: '/prod_whole_squid_1784093059412.png',
      ...
      <section className="py-24 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-[2.75rem] font-bold text-[#0a3161] tracking-tight">Crustaceans & Cephalopods</h2>
          </div>
