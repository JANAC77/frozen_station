  ...
  const specificProducts = [
    {
      ...
      image: '/prod_indian_mackerel_1784093100281.png',
    ...
    },
    {
      id: 'ribbon-fish',
      name: 'Ribbon Fish',
      image: '/prod_ribbon_fish_1784093121441.png',
      actionText: 'Contact Us',
      actionIcon: <Smartphone size={24} className="text-white opacity-90" strokeWidth={1.5} />
    },
    {
      ...
      <section className="py-24 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-[2.75rem] font-bold text-[#0a3161] tracking-tight">Fishes</h2>
          </div>
